...
<body>
    ...
    <div class="container">
        ...
        <h1 class="col-12 h3 mb-3 text-center text-danger">El usuario o la contraseña son incorrectas</h1>
            <h1 class="col-12 h3 mb-3 text-center">Registrar Administrador</h1>
            ...
            <br>
            <div class="row justify-content-center text-center">
                <button class="col-2 btn btn-lg btn-primary" name="registrar" value="registrar" type="submit">Registrarse </button>
            </div>
        </form>
    </div>
